...
function sendAndStoreMessages(rankList) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const storePromises = rankList.map((article, index) => __awaiter(this, void 0, void 0, function* () {
                let id;
                if (index < config_1.LIMIT_SEND_COUNT) {
                    id = yield (0, article_1.createArticle)(Object.assign(Object.assign({}, article), { is_send: true }));
                }
                else {
                    id = yield (0, article_1.createArticle)(article);
                }
                if (index < config_1.LIMIT_SEND_COUNT) {
            ...
            // 发送消息
            const sendResult = formatMissionJsonSave(rankList.slice(0, config_1.LIMIT_SEND_COUNT));
            // 等待发送消息的结果
