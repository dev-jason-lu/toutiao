...
const click_1 = require("./service/click");
function sleep(ms) {
...
function processContent(demoWebsite) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sendResult = yield (0, send_1.sendAndStoreMessages)(rankList);
        if (sendResult) {
            console.log("success!");
        }
        else {
        ...
        if (req.body) {
            ...
            if (body.event) {
                if (body.header.event_type === "card.action.trigger") {
                    ...
                    const result = yield (0, click_1.insertClick)(Number(article_id), user_id);
                    if (!result) {
