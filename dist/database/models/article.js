...
function createArticle(article) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield db_1.default.query('INSERT INTO articles (title, article_link, article_abstract, article_content, tags, score, is_send) VALUES ($1, $2, $3, $4, $5, $6, $7) ON CONFLICT (article_link) DO UPDATE SET is_send = EXCLUDED.is_send RETURNING id', [title, article_link, article_abstract, article_content, tags, score, is_send]);
