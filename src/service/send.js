...
function sendAndStoreMessages(rankList, abstractList, linkSet) {
    return __awaiter(this, void 0, void 0, function () {
        var sendResult, storePromises, sendResultValue, idList, filteredIdList, error_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    sendResult = formatMissionJsonSave(rankList);
                    storePromises = abstractList.map(function (article) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            if (linkSet.has(article.article_link)) {
                                return [2 /*return*/, (0, article_1.createArticle)(__assign(__assign({}, article), { is_send: true }))];
                            }
                            return [2 /*return*/, (0, article_1.createArticle)(article)];
                        });
                    }); });
                ...
                case 2:
                    ...
                    filteredIdList = idList.filter(function (id) { return id !== null; });
                    ...
                    return [2 /*return*/, sendResultValue && filteredIdList.length > 0];
                case 3:
                    error_1 = _a.sent();
